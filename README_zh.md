...
[![Tests](https://img.shields.io/badge/tests-100%20passed%2C%200%20failed-brightgreen.svg)]()
...
计算完整四柱、日主五行阴阳、大运流程（标明虚岁）、地支刑冲合会、神煞与诊断元数据。
...
| `sect` | number | 可选 | 早晚子时口径：`1`（默认，00:00 换日）或 `2`（23:00 换日） |
